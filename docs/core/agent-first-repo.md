...
```bash
npx skills add edheltzel/Do-Skills --skill=do-agent-first-repo
```
...
[Source](https://github.com/edheltzel/Do-Skills/tree/master/skills/core/do-agent-first-repo)
...
Type `/do-agent-first-repo`, or the agent reaches for it automatically when you're
...
[agents-md](../core/agents-md.md) and [architecture-md](../core/architecture-md.md), which each
