...
```bash
npx skills add edheltzel/skills --skill=agents-md
```

```bash
npx skills update agents-md
```

[Source](https://github.com/edheltzel/skills/tree/main/skills/core/agents-md)
...
architecture it sits inside, use [agent-first-repo](./agent-first-repo.md); for the
...
layer of [agent-first-repo](./agent-first-repo.md)'s knowledge hierarchy, and hands
