...
```bash
npx skills add edheltzel/skills --skill=design-patterns-gof
```

```bash
npx skills update design-patterns-gof
```

[Source](https://github.com/edheltzel/skills/tree/main/skills/core/design-patterns-gof)
...
code once you've named it, use [karpathy-guidelines](./karpathy-guidelines.md).
...
[karpathy-guidelines](./karpathy-guidelines.md)' simplicity-first bias, and its
language-native leanings echo the craft skills in
[`engineering/`](../engineering/) — for the TypeScript form of "prefer a union
over a hierarchy," see [typescript](../engineering/typescript.md).
