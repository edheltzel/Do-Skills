...
```bash
npx skills add edheltzel/skills --skill=roughdraft
```

```bash
npx skills update roughdraft
```

[Source](https://github.com/edheltzel/skills/tree/main/skills/core/roughdraft)
...
review handoff at the end of any writing task. It sits alongside the writing
skills in [`productivity/`](../productivity/), such as
[tech-writing](../productivity/tech-writing.md), which produce the drafts
