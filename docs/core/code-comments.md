...
```bash
npx skills add edheltzel/skills --skill=code-comments
```

```bash
npx skills update code-comments
```

[Source](https://github.com/edheltzel/skills/tree/main/skills/core/code-comments)
...
counterpart to [karpathy-guidelines](./karpathy-guidelines.md)' surgical-change
