...
the same buckets used under [`skills/`](../skills/). Each page explains what a
skill does, when to reach for it, and where it sits among the others — it is not
a copy of the skill's `SKILL.md`.
