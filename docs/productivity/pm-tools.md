...
```bash
npx skills add edheltzel/skills --skill=pm-tools
```

```bash
npx skills update pm-tools
```

[Source](https://github.com/edheltzel/skills/tree/main/skills/productivity/pm-tools)
