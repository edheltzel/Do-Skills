---
name: do-humanize
description: Rewrite AI-generated developer text to sound human — fix inflated language, filler, tautological docs, and robotic tone. Use after do-review-ai-writing identifies issues.
...
Apply fixes from a previous [do-review-ai-writing](../do-review-ai-writing/SKILL.md) run with automatic safe/risky classification. Builds on the writing principles in [docs-style](references/docs-style.md).

## Usage

Invoke the **do-humanize** skill with optional flags: `do-humanize [--dry-run] [--all] [--category <name>]`.
...
**If file missing:**
- If `--all` flag: Invoke the **[do-review-ai-writing](../do-review-ai-writing/SKILL.md)** skill with `--all` first
- Otherwise: Fail with: "No review results found. Invoke the do-review-ai-writing skill first."
...
Invoke the **do-humanize** skill with flags:
