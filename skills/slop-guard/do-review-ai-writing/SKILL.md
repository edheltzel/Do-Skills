...
Invoke the **do-review-ai-writing** skill with optional flags: `do-review-ai-writing [--all] [--category <name>] [path]`.
...
Read [review-verification-protocol](references/review-verification-protocol.md) before reporting findings. The AI-writing pattern catalog lives in this file's Reference Material section and the `references/*.md` files — read the categories you intend to check.
...
- Always read this skill's pattern catalog and read [review-verification-protocol](references/review-verification-protocol.md) first
...
### With [review-verification-protocol](references/review-verification-protocol.md)
