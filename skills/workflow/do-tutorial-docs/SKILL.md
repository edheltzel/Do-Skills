...
**Dependency:** Read [docs-style](references/docs-style.md) for core writing principles. To confirm a tutorial is the right type — rather than a how-to, reference, or explanation — see [diataxis-compass.md](references/diataxis-compass.md).
...
For the full compass procedure and the other type distinctions, see [diataxis-compass.md](references/diataxis-compass.md).
