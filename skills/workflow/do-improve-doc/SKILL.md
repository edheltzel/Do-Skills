...
Invoke the **do-improve-doc** skill with a document path, e.g. `improve-doc docs/guides/getting-started.md`.
...
2. **Core skill** — [docs-style](references/docs-style.md) is loaded (or its path read) before classification.
...
Load [docs-style](references/docs-style.md) for core writing principles that apply to all documentation types.

### Step 3: Classify Each Section

For each section, determine the Diataxis type using these indicators (for the full decision procedure and the two key distinctions, see [docs-style/references/diataxis-compass.md](references/diataxis-compass.md)):
...
- Tutorial sections: [tutorial-docs](../do-tutorial-docs/SKILL.md)
- How-To sections: [howto-docs](references/howto-docs.md)
- Reference sections: [reference-docs](references/reference-docs.md)
- Explanation sections: [explanation-docs](references/explanation-docs.md)
