...
The canonical reference for choosing a documentation type and judging its quality, drawn from the [Diataxis framework](https://diataxis.fr/). This file is self-contained: reach for it when the documentation type is ambiguous.
