---
name: teach
description: Teach the user a new skill or concept over multiple sessions, within a stateful teaching workspace — grounding every lesson in a mission, building reference docs, and tracking learning records to stay in the zone of proximal development. USE WHEN the user types its name and names something they want to learn; the request is stateful and spans sessions. NOT FOR a one-off explanation or drafting documentation (use tech-writing).
---
