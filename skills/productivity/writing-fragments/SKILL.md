...
description: Writing, explore — mine raw fragments into one file, no structure yet. USE WHEN you type its name to start a piece from scratch and want to widen the space of what could be written before committing to a shape. Feeds writing-drafting, the exploit phase that shapes the pile. NOT FOR turning a fixed pile into an article (use writing-drafting).
---

<what-to-do>

This is pure **explore**: widen the space of what could be written without committing to structure — committing is _exploit_, the writing-drafting skill's job. Run a grilling session that produces fragments, interviewing the user relentlessly about whatever they want to write about. Imposing phases, outlines, or article structure is out of scope here.
