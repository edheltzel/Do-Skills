...
# Usage: bash skills/personal/update-readme/update-readme.sh
set -euo pipefail
...
BUCKET_ORDER="core engineering productivity personal"
...
bucket_blurb() {
    case "$1" in
        core)         echo "Always-on standards, process, and operational skills. Stack-agnostic — they apply to any project." ;;
        engineering)  echo "Stack-specific code craft — reached for once the language, framework, or platform is known." ;;
        productivity) echo "Non-code workflow tools." ;;
        personal)     echo "Tied to this repository's own tooling. Not portable." ;;
        *)            echo "" ;;
    esac
}
