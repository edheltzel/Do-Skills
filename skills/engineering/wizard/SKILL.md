...
description: >-
  ...
  third-party setup, a one-off migration, an A→B state transition — opening URLs, capturing
  values, confirming each step, and writing .env files and GitHub Actions secrets. USE WHEN
  the user wants a guided setup script, an onboarding wizard, or a repeatable manual-procedure
  runner. NOT FOR Husky/Prettier commit hooks (use setup-pre-commit) or non-interactive code
  generation. User-invoked.
---
