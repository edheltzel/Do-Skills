...
4. **Protocol** — Load and complete the [review-verification-protocol](../review-verification-protocol.md) skill **after** gates 1–3 and **before** final severity labels. **Pass:** Protocol steps satisfied for each retained finding.
...
Complete **Gates (evidence before severity)**, then load and follow the [review-verification-protocol](../review-verification-protocol.md) skill before reporting any issue.
