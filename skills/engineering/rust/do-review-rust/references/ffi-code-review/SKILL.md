...
**PASS when:** You loaded and applied the [review-verification-protocol](../review-verification-protocol.md) skill, including **FFI-Specific Verification** for `repr(C)`, safety comments, ownership/callbacks, or bindgen-heavy code.
...
Complete **Gates 1-4 in order** before reporting any issue; Gate 4 incorporates the [review-verification-protocol](../review-verification-protocol.md) skill.
