...
4. **Protocol** — Load the [review-verification-protocol](../review-verification-protocol.md) skill. **Pass:** Its pass conditions met before any finding is reported (file:line evidence for asserted issues).
...
After **Gates**, apply the [review-verification-protocol](../review-verification-protocol.md) skill to every reported issue (evidence and dispositions per that skill).
