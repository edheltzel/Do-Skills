...
4. **Verification protocol** — Before finalizing the report. **Pass:** the [review-verification-protocol](../review-verification-protocol.md) skill is loaded and every step in it that applies to this review is completed (do not substitute a vague “I checked”).
...
Satisfy **Gates** § verification protocol (step 4). Load and follow the [review-verification-protocol](../review-verification-protocol.md) skill before reporting any issue.
