...
3. **Verification protocol** — **Pass:** steps from the [review-verification-protocol](../review-verification-protocol.md) skill are done before any finding is listed (see **Before Submitting Findings**).
...
Load and follow the [review-verification-protocol](../review-verification-protocol.md) skill before reporting any issue.
