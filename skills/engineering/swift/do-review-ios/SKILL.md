...
**Always load:**
- [swift-code-review](references/swift-code-review/SKILL.md)
- [swiftui-code-review](references/swiftui-code-review/SKILL.md)

**Conditionally load based on detection:**

| Condition | Skill |
|-----------|-------|
| SwiftData detected | [swiftdata-code-review](references/swiftdata-code-review/SKILL.md) |
| Swift Testing detected | [swift-testing-code-review](references/swift-testing-code-review/SKILL.md) |
| Combine detected | [combine-code-review](references/combine-code-review/SKILL.md) |
| URLSession detected | [urlsession-code-review](references/urlsession-code-review/SKILL.md) |
| CloudKit detected | [cloudkit-code-review](references/cloudkit-code-review/SKILL.md) |
| WidgetKit detected | [widgetkit-code-review](references/widgetkit-code-review/SKILL.md) |
| App Intents detected | [app-intents-code-review](references/app-intents-code-review/SKILL.md) |
| HealthKit detected | [healthkit-code-review](references/healthkit-code-review/SKILL.md) |
| WatchKit detected | [watchos-code-review](references/watchos-code-review/SKILL.md) |
| Animation code detected | [ios-animation-code-review](references/ios-animation-code-review/SKILL.md) |
