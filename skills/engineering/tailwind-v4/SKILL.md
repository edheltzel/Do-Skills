---
name: tailwind-v4
description: Tailwind CSS v4 with CSS-first configuration, @theme design tokens, OKLCH color, and dark-mode strategies. USE WHEN setting up Tailwind v4, defining @theme variables, migrating a v3 config to CSS-first, choosing OKLCH tokens, wiring the @tailwindcss/vite plugin, or configuring dark mode. Triggers on @theme, @tailwindcss/vite, oklch, CSS variables, --color-, tailwind v4. NOT FOR component API, accessibility, or token architecture (use design-system) or framework-agnostic native CSS techniques not tied to Tailwind (use modern-css).
---
