...
3. **Protocol gate:** [review-verification-protocol](references/review-verification-protocol.md) is loaded before Step 6. **Pass:** At least one reported finding was checked against that checklist (state which item in the Review Summary or first Critical/Major note).
...
**Always load:**
- [elixir-code-review](references/elixir-code-review/SKILL.md)

**Conditionally load based on detection:**

| Condition | Skill |
|-----------|-------|
| Phoenix detected | [phoenix-code-review](references/phoenix-code-review/SKILL.md) |
| LiveView detected | [liveview-code-review](references/liveview-code-review/SKILL.md) |
| Performance focus requested | [elixir-performance-review](references/elixir-performance-review/SKILL.md) |
| Security focus requested | [elixir-security-review](references/elixir-security-review/SKILL.md) |
| Test files changed | [exunit-code-review](references/exunit-code-review/SKILL.md) |
