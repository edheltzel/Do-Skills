...
3. **Cross-protocol verification** — Apply [review-verification-protocol](../review-verification-protocol.md) (e.g. read full function/block, search usages before “unused” claims) to that same finding.
