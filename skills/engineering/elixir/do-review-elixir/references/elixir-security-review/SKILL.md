...
4. **Protocol** — Pre-report steps in [review-verification-protocol](../review-verification-protocol.md) are satisfied for this item (no finding if they are not).

## Before Submitting Findings

Use the issue format: `[FILE:LINE] ISSUE_TITLE` for each finding.

Hard gate 4 requires [review-verification-protocol](../review-verification-protocol.md); use it as the full pre-report checklist and issue-type verification (it extends beyond this skill’s summary).
