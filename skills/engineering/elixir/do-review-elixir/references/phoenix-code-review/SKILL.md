...
3. **Verification protocol** — Load and apply [review-verification-protocol](../review-verification-protocol.md) for the issue type. **Pass:** that skill’s pre-report checks for that finding class are satisfied before you write the finding.
...
Do not report until **Gates** above pass. For full anti-false-positive steps, follow [review-verification-protocol](../review-verification-protocol.md).
