...
Load the [review-verification-protocol](../review-verification-protocol.md) skill before any substantive judgment on code.
...
2. **Protocol + always skills loaded** — **Pass when:** [review-verification-protocol](../review-verification-protocol.md) and all six `remix-v2-*-review` skills are loaded before the first severity judgment.
