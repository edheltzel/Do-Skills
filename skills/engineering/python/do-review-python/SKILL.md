...
| **G3 — Protocol and base skills** | The [review-verification-protocol](references/review-verification-protocol.md), [python-code-review](references/python-code-review/SKILL.md), and [fastapi-code-review](references/fastapi-code-review/SKILL.md) skills are loaded before Step 6 substantive review. |
...
**Always load:**
- [python-code-review](references/python-code-review/SKILL.md)
- [fastapi-code-review](references/fastapi-code-review/SKILL.md)
