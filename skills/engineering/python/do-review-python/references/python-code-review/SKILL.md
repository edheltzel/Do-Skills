...
4. **Verification protocol** — **Pass:** You load [review-verification-protocol](../review-verification-protocol.md) and complete its mandatory steps **for each reported issue** before the user-facing write-up.
