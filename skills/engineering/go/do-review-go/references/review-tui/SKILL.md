...
| **G2 — Skills before review** | [review-verification-protocol](../review-verification-protocol.md), [go-code-review](../go-code-review/SKILL.md), and [bubbletea-code-review](../bubbletea-code-review/SKILL.md) are loaded; Step 4 conditionals (tests → [go-testing-code-review](../go-testing-code-review/SKILL.md), Wish → [wish-ssh-code-review](../wish-ssh-code-review/SKILL.md)) are loaded **before** Step 5. |
...
Load the **[review-verification-protocol](../review-verification-protocol.md)** skill and keep its checklist in mind throughout the review.
